    ...
    <div className='tickets'>
      ...
      <div className='tickets-col-1'>
        <div className='tickets-col-1-a'>
            ...
            <p className='tickets-col-1-a-p md:w-[25rem]'>Secure your preferred ticket now and immerse yourself in the world of tech innovation, networking with industry experts, and the chance to win exciting tech gadgets.
            </p> 
        </div>
