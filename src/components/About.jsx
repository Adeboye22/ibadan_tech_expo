...
const About = () => {
    return (
        <section>
            <div className="mx-auto font-primary container mt-[90px] md:mt-[160px] lg:mt-[150px] mb-10">
                {aboutData.map((data, i)=> {
                    const { titleImg, desc, descImg } = data
                    return (
                        <div key={i} className="flex flex-col md:flex-row items-center">
                            <div className='w-full'> 
                                <img className='border-b-2 border-secondary relative w-full mb-5 md:mb-0' src={titleImg} alt="" />
